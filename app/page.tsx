...
export default function StatmericaHomepage() {
  return (
    <div className="min-h-screen relative bg-background">
      <div id="pattern" className="z-40 pointer-events-none opacity-10 absolute inset-0 bg-[length:20%_20%] bg-[url('/dot-grid-l.png')] dark:bg-[url('/dot-grid-d.png')]"></div>
      <SiteHeader />
      ...
      <div className="w-full relative z-10 -mt-[85px] border-t border-dashed">
