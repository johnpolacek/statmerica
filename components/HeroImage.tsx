...
export default function HeroImage() {
  return (
    <div className="w-full aspect-[2] xl:w-auto xl:h-[720px] xl:aspect-auto">
      ...
      <div className="hidden xl:block w-72 h-full bg-gradient-to-r via-background/70 from-background to-transparent absolute bottom-0 left-0"></div>
      <div className="hidden xl:block w-72 h-full bg-gradient-to-l via-background/70 from-background to-transparent absolute bottom-0 right-0"></div>
    </div>
  )
}
